<template>
    <header id="rail" class="fixed top-0 bottom-0 vh-100 smooth">
      <nav class="pt5">
        <div class="p2">
          <g-link to="/">
            <Ologo />
        ...
        <g-link class="nav-link d-block tc bold p2" to="/hire">
          <IconCase />
          <small>Hire Me</small>
        </g-link>
      </nav>
...
export default {
    name: 'Rail',
    components: { Ologo, IconHome, IconAbout, IconProjects, IconCase },
}
</script>